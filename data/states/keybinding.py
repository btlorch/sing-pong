...
class KeyBinding(tools.States):
    def __init__(self, screen_rect):
        ...
        self.options = ['Back']
        self.next_list = ['MENU']
        self.title, self.title_rect = self.make_text('Key Bindings', (
            75, 75, 75), (self.screen_rect.centerx, 75), 75)
        self.pre_render_options()
        self.from_bottom = 400
        self.spacer = 75
        self.set_buttons()

        self.key_up_text, self.key_up_text_rect = self.make_text('UP', (
            75, 75, 75), (self.screen_rect.centerx - 90, 140), 20)
        self.key_down_text, self.key_down_text_rect = self.make_text('DOWN', (
            75, 75, 75), (self.screen_rect.centerx - 90, 175), 20)
    ...
    def set_buttons(self):
        ...
        self.up_keybinding = button.Button(
            (centerX, 125, btn_width, btn_height), **self.up_button_settings)
        self.down_keybinding = button.Button(
            (centerX, 160, btn_width, btn_height), **self.down_button_settings)
